...
export const CountdownComponent: React.FC<CountdownComponentProps> = ({ component }) => {
  ...
  return (
    <div style={containerStyle} className="w-full h-full flex flex-col items-center justify-center select-none">
      {/* ✅ Sửa tiêu đề: bỏ font-serif, dùng fontFamily từ container */}
      <h4 
        className="font-bold text-sm text-slate-800 mb-3 uppercase tracking-wider"
