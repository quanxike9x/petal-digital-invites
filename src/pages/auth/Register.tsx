    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-900/80 border border-slate-800 rounded-3xl p-8 backdrop-blur-xl shadow-2xl space-y-6 relative z-10">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-white">Đăng ký tài khoản</h1>
          <p className="text-xs text-slate-400">Tạo thiệp cưới dùng thử miễn phí trong 14 ngày</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-xs text-slate-300 font-medium block mb-1">Họ và tên</label>
            <input
              type="text"
