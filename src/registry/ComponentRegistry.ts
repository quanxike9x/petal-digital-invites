  ...
  return {
    ...
    layout: {
      position: {
        x: 0,
        y: 0,
        width: definition.defaultStyle.width ? String(definition.defaultStyle.width) : '100%',
        height: definition.defaultStyle.height ? String(definition.defaultStyle.height) : 'auto',
        minWidth: '40px',
        minHeight: '20px',
        maxWidth: '100%',
        maxHeight: 'none',
